    ...
    <div class="products">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href=""><img src="<?= Yii::$app->request->baseUrl;?>/theme/assets/images/product-2-370x270.jpg" alt=""></a>
              <div class="down-content">
                <a href="package-details.html"><h4>Limelight Lodge</h4></a>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="package-details.html"><img src="<?= Yii::$app->request->baseUrl;?>/theme/assets/images/product-4-370x270.jpg" alt=""></a>
              <div class="down-content">
                <a href="package-details.html"><h4>Limelight Lodge</h4></a>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="package-details.html"><img src="<?= Yii::$app->request->baseUrl;?>/theme/assets/images/product-5-370x270.jpg" alt=""></a>
              <div class="down-content">
                <a href="package-details.html"><h4>Limelight Lodge</h4></a>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="package-details.html"><img src="<?= Yii::$app->request->baseUrl;?>/theme/assets/images/product-6-370x270.jpg" alt=""></a>
              <div class="down-content">
                <a href="package-details.html"><h4>Limelight Lodge</h4></a>
